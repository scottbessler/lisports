...
pub fn router(data: Arc<dyn SportsData>) -> Router {
    Router::new()
        ...
        .route(
            "/worldcup/scoreboard/today",
            axum::routing::get(routes::worldcup_scoreboard_today),
        )
        .route(
            "/worldcup/scoreboard/{day}",
            axum::routing::get(routes::worldcup_scoreboard_day),
        )
        .route(
            "/worldcup/scoreboard/{day}/game/{game_id}",
            axum::routing::get(routes::worldcup_game),
        )
        .route(
            "/worldcup/standings",
        ...
        .route(
            "/nwsl/scoreboard/today",
            axum::routing::get(routes::nwsl_scoreboard_today),
        )
        .route(
            "/nwsl/scoreboard/{day}",
            axum::routing::get(routes::nwsl_scoreboard_day),
        )
        .route(
            "/nwsl/scoreboard/{day}/game/{game_id}",
            axum::routing::get(routes::nwsl_game),
        )
        .route(
            "/nwsl/standings",
            axum::routing::get(routes::nwsl_standings),
        )
