...
T1|.|add league registry/config for route base, sport path, date-vs-week bucket, nav label, logo path, feature flags|V18,V19,I.http.nba,I.http.wnba,I.http.mlb,I.http.nfl,I.http.nhl
